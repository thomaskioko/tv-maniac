...
class FetchRateEpisodeInteractorTest {
    private val ratingsRepository = FakeRatingsRepository()

    private val interactor = FetchRateEpisodeInteractor(
        ratingsRepository = ratingsRepository,
    )

    @Test
    fun `should emit success given episode is rated`() = runTest {
        val param = FetchRateEpisodeInteractor.Param(episodeId = 84958L, rating = 8)
