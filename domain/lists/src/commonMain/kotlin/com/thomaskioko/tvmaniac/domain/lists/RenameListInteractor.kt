...
@Inject
public class RenameListInteractor(
    private val repository: ListRepository,
    private val userRepository: UserRepository,
    private val activeProviderFeatures: () -> ProviderFeatures,
) : Interactor<RenameListInteractor.Params>() {
    ...
    override suspend fun doWork(params: Params) {
        ...
        repository.renameList(listId = params.listId, name = params.name.trim(), traktSlug = traktSlug)
    }

    public data class Params(val listId: Long, val name: String)
