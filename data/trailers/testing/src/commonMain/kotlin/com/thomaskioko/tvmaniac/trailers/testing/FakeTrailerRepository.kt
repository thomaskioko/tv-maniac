...
public class FakeTrailerRepository : TrailerRepository {
    ...
    private var response = MutableStateFlow<List<SelectByShowTmdbId>>(emptyList())

    public suspend fun setTrailerResult(result: List<SelectByShowTmdbId>) {
    ...
    override fun observeTrailers(id: Long): Flow<List<SelectByShowTmdbId>> = response.asStateFlow()
