...
class SearchScreenTest: SnapshotTestCase {
    ...
    func test_SearchScreen_Loading() {
        ...
        view.assertSnapshot(layout: .defaultDevice, liquidGlass: true, settleSystemSearch: true, testName: "SearchScreen_Loading")
    }
    ...
    func test_SearchScreen_BrowsingGenres() {
        ...
        view.assertSnapshot(layout: .defaultDevice, liquidGlass: true, settleSystemSearch: true, testName: "SearchScreen_BrowsingGenres")
    }
    ...
    func test_SearchScreen_SearchResults() {
        ...
        view.assertSnapshot(layout: .defaultDevice, liquidGlass: true, settleSystemSearch: true, testName: "SearchScreen_SearchResults")
    }
    ...
    func test_SearchScreen_SearchResults_Updating() {
        ...
        view.assertSnapshot(layout: .defaultDevice, liquidGlass: true, settleSystemSearch: true, testName: "SearchScreen_SearchResults_Updating")
    }
    ...
    func test_SearchScreen_Empty() {
        ...
        view.assertSnapshot(layout: .defaultDevice, liquidGlass: true, settleSystemSearch: true, testName: "SearchScreen_Empty")
    }
    ...
    func test_SearchScreen_Error() {
        ...
        view.assertSnapshot(layout: .defaultDevice, liquidGlass: true, settleSystemSearch: true, testName: "SearchScreen_Error")
    }
