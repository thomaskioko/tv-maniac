...
let package = Package(
    ...
    dependencies: [
        ...
        .package(name: "GenreShows", path: "../GenreShows"),
        ...
        .package(name: "WatchDateSelection", path: "../WatchDateSelection"),
        .package(name: "Trailers", path: "../Trailers"),
        .package(name: "Statistics", path: "../Statistics"),
        .package(name: "Lists", path: "../Lists"),
