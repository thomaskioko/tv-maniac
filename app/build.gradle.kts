...
dependencies {
    ...
    implementation(projects.core.deeplink.api)
    implementation(projects.core.deeplink.implementation)
    ...
    implementation(projects.features.genreShows.ui)
    ...
    implementation(projects.features.statistics.ui)
    ...
    implementation(projects.features.lists.presenter)
    ...
    implementation(projects.features.statistics.presenter)
    ...
    testImplementation(projects.core.integration.stubs)
