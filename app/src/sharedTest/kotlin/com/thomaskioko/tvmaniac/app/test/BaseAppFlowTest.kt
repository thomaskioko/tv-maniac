...
import com.thomaskioko.tvmaniac.app.test.compose.robot.MyShowsRobot
...
import com.thomaskioko.tvmaniac.app.test.compose.robot.RatingSheetRobot
...
internal class AppFlowScope(
    ...
    val listsRobot: ListsRobot by lazy { ListsRobot(composeUi) }
    val listDetailRobot: ListDetailRobot by lazy { ListDetailRobot(composeUi) }
