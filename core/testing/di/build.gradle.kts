...
kotlin {
    sourceSets {
        commonMain.dependencies {
            ...
            api(projects.features.search.nav.api)
            api(projects.features.search.nav.implementation)
            api(projects.features.debug.nav.api)
            api(projects.features.debug.nav.implementation)
            api(projects.features.settings.nav.api)
            api(projects.features.settings.nav.implementation)
            api(projects.features.library.nav.api)
            api(projects.features.library.nav.implementation)
            api(projects.features.profile.nav.api)
            api(projects.features.profile.nav.implementation)
            api(projects.features.moreShows.nav.api)
            api(projects.features.moreShows.nav.implementation)
            api(projects.features.calendar.nav.api)
            api(projects.features.calendar.nav.implementation)
            api(projects.features.discover.nav.api)
            api(projects.features.discover.nav.implementation)
            api(projects.features.episodeDetail.nav.api)
            api(projects.features.episodeDetail.nav.implementation)
            api(projects.features.seasonDetails.nav.api)
            api(projects.features.seasonDetails.nav.implementation)
            api(projects.features.showDetails.nav.api)
            api(projects.features.showDetails.nav.implementation)
            api(projects.features.upnext.nav.api)
            api(projects.features.upnext.nav.implementation)
            api(projects.features.watchlist.nav.api)
            api(projects.features.watchlist.nav.implementation)
