package com.thomaskioko.tvmaniac.testtags.home

public object HomeTestTags {
    public const val NAVIGATION_BAR: String = "home_navigation_bar"
    public const val DISCOVER_TAB: String = "home_tab_discover"
    public const val PROGRESS_TAB: String = "home_tab_progress"
    public const val MY_SHOWS_TAB: String = "home_tab_my_shows"
