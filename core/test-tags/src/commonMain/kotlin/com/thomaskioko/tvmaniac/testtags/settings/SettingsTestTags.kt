...
public object SettingsTestTags {
    ...
    public const val WIDGET_APPEARANCE_ROW_TEST_TAG: String = "settings_widget_appearance_row"
    public const val WIDGET_APPEARANCE_LOCKED_TEST_TAG: String = "settings_widget_appearance_locked"
    public const val WIDGET_APPEARANCE_PREVIEW_TEST_TAG: String = "settings_widget_appearance_preview"
    public fun widgetThemeChip(name: String): String = "settings_widget_theme_chip_${name.lowercase()}"
