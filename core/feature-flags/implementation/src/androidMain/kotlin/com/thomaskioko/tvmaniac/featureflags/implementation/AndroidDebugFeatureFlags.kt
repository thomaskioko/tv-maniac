...
@ContributesBinding(AppScope::class, replaces = [AndroidRemoteConfigFeatureFlags::class])
public class AndroidDebugFeatureFlags(
    private val production: AndroidRemoteConfigFeatureFlags,
