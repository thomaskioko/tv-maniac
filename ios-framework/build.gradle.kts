...
scaffold {
    ...
    addIosTargetsWithXcFramework(
        ...
        with(framework) {
            ...
            export(projects.features.seasonDetails.nav.api)
            export(projects.features.settings.presenter)
            export(projects.features.showDetails.nav.api)
            ...
            export(projects.features.episodeDetail.presenter)
    ...
    sourceSets {
        commonMain {
            dependencies {
                ...
                api(projects.features.episodeDetail.presenter)
                api(projects.features.root.presenter)
                api(projects.features.seasonDetails.nav.api)
