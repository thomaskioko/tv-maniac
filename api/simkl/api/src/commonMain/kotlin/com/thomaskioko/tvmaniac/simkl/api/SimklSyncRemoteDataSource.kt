...
public interface SimklSyncRemoteDataSource {
    public suspend fun getLastActivities(): ApiResponse<SimklLastActivitiesResponse>
    ...
    public suspend fun addToList(request: SimklAddToListRequest): ApiResponse<SimklAddToListResponse>
}
