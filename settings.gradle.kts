...
include(
    ...
    ":data:cast:testing",
    ":data:connected-account:api",
    ":data:connected-account:implementation",
    ":data:connected-account:testing",
    ...
    ":data:sync-provider:api",
    ":data:sync-provider:implementation",
    ":data:sync-provider:testing",
