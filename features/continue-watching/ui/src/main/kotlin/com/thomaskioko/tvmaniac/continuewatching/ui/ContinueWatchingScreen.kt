...
import com.thomaskioko.tvmaniac.continuewatching.presenter.ChangeContinueWatchingListStyle
import com.thomaskioko.tvmaniac.continuewatching.presenter.ChangeContinueWatchingSortOption
...
import com.thomaskioko.tvmaniac.continuewatching.presenter.ToggleContinueWatchingSearch
...
import com.thomaskioko.tvmaniac.continuewatching.ui.component.Searchbar
...
public fun ContinueWatchingScreen(
    ...
    if (showSortOptions) {
        ModalBottomSheet(
            ...
            ContinueWatchingSortOptionsContent(
                selectedSortOption = state.sortOption,
                onSortOptionSelected = { sortOption ->
                    onAction(ChangeContinueWatchingSortOption(sortOption))
                    scope.launch {
                        sheetState.hide()
...
private fun TopBar(
    ...
    BackHandler(enabled = state.isSearchActive) {
        onAction(ClearContinueWatchingQuery)
        onAction(ToggleContinueWatchingSearch)
    }
            ...
            AnimatedContent(
                ...
                if (expanded) {
                    Searchbar(
                        ...
                        onQueryChanged = { onAction(ContinueWatchingQueryChanged(it)) },
                        onCloseClick = {
                            onAction(ClearContinueWatchingQuery)
                            onAction(ToggleContinueWatchingSearch)
                        },
                    ...
                    CollapsedTopBarContent(
                        state = state,
                        onAction = onAction,
                        onSearchClick = { onAction(ToggleContinueWatchingSearch) },
...
private fun CollapsedTopBarContent(
    ...
    Row(
        ...
        IconButton(
            ...
            onClick = { onAction(ChangeContinueWatchingListStyle(state.isGridMode)) },
        ) {
