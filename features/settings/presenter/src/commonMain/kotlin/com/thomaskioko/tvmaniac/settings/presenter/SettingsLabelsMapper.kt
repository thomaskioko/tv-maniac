...
public class SettingsLabelsMapper(
    ...
    public operator fun invoke(
        ...
        widgetAppearance = WidgetAppearanceLabels(
            ...
            subtitle = localizer.getString(StringResourceKey.SettingsWidgetDescription),
            livePreview = localizer.getString(StringResourceKey.SettingsWidgetLivePreview),
            themeLabel = localizer.getString(StringResourceKey.SettingsWidgetThemeLabel),
            matchAppTheme = localizer.getString(StringResourceKey.SettingsWidgetThemeMatchApp),
        ),
    ...
    public fun toPremiumState(access: PremiumAccess): PremiumState = PremiumState(
        ...
        widgetThemingLocked = !access.widgetTheming,
