...
public data class SettingsState(
    ...
    val rowPosterWidth: PosterWidth = PosterWidth.STANDARD,
    val gridPosterWidth: PosterWidth = PosterWidth.STANDARD,
    val posterCornerStyle: PosterCornerStyle = PosterCornerStyle.ROUNDED,
