...
sealed interface RootDestinationConfig {
  @Serializable data object Home : RootDestinationConfig

  @Serializable data class ShowDetails(val id: Long) : RootDestinationConfig

  @Serializable data class SeasonDetails(val param: SeasonDetailsUiParam) : RootDestinationConfig
